...
export default class gameScene2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.lives = 3;
        this.scoreText = this.add.text(325,235,'Crystals:' + this.score + '/30', {fontSize: '15px'});
        ...
        if (this.spaceKey.isDown && this.hero.body.blocked.down)
    {
        ...
        //char data
        this.hero = this.physics.add.sprite(1651, 177, 'hero', 0);
    ...
    finishOrb(hero,fin){
        ...
        this.scene.start('endScene2', {score: this.score});
        return false;
    ...
    collectCryst(hero,crys){
        ...
        this.score += 1;
        this.scoreText.setText('Crystals: ' + this.score + '/30');
        return false;
    }
