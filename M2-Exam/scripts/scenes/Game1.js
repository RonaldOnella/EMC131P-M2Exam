...
export default class gameScene1 extends Phaser.Scene {
    ...
    create() {
        ...
        this.score = 0;
        this.lives = 3;
        this.scoreText = this.add.text(325,235,'Crystals:' + this.score + '/10', {fontSize: '15px'});
    ...
    finishOrb(hero,fin){
        ...
        this.scene.start('endScene1', {score: this.score});
        return false;
    ...
    collectCryst(hero,crys){
        ...
        this.score += 1;
        this.scoreText.setText('Crystals: ' + this.score + '/10');
        return false;
    }
